<template>
  <footer class="bg-black text-white border-t border-neutral-900 px-6 py-8">
    <div class="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div class="flex items-center gap-4">
        <a
          ...
          target="_blank"
          :title="social.label"
          class="w-8 h-8 flex items-center justify-center text-gray-500 hover:text-white transition"
          v-html="social.icon"
        ></a>
      </div>
      ...
      <a
        ...
        target="_blank"
        class="flex items-center gap-2 text-xs text-yellow-600 hover:text-yellow-400 transition border border-yellow-600/30 hover:border-yellow-500/50 px-4 py-2 rounded-lg"
      >
        ☕ Traktir Kopi
      </a>
