<template>
  <section class="bg-black text-white min-h-[calc(100vh-120px)] px-6 py-16">
    <div class="w-full max-w-5xl mx-auto">

      <!-- HEADER -->
      <div class="mb-16">
        <p class="text-xs tracking-[0.3em] text-gray-500 uppercase mb-3">Who I Am</p>
        <h1 class="text-5xl font-bold tracking-tight leading-tight">
          About <span class="text-gray-400">Me</span>
        </h1>
      ...
      <div class="space-y-16">
        ...
        <!-- 1. TECH STACK -->
        <div>
          <p class="text-xs tracking-[0.3em] text-gray-500 uppercase mb-3">Development</p>
          ...
          <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
            <div
              ...
              :key="skill.name"
              class="group flex flex-col items-center gap-3 border border-neutral-800 rounded-xl py-5 px-3 hover:border-neutral-500 hover:bg-neutral-900 transition cursor-default"
            >
              <img
                :src="skill.icon"
                :alt="skill.name"
                class="h-10 w-10 object-contain group-hover:scale-110 transition-transform duration-200"
              />
              <span class="text-xs text-gray-400 group-hover:text-white transition text-center">
                {{ skill.name }}
              </span>
            </div>
          </div>
        ...
        <!-- 2. SOFTWARE & TOOLS -->
        <div>
          <p class="text-xs tracking-[0.3em] text-gray-500 uppercase mb-3">Productivity & Design</p>
          <h2 class="text-2xl font-bold mb-8">Software & Tools</h2>
        ...
        <!-- 3. SOFT SKILLS -->
        <div>
          <p class="text-xs tracking-[0.3em] text-gray-500 uppercase mb-3">Interpersonal</p>
          <h2 class="text-2xl font-bold mb-8">Soft Skills</h2>

          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            <div
              v-for="soft in softSkills"
              :key="soft"
              class="border border-neutral-800 rounded-xl py-4 px-5 hover:border-neutral-600 hover:bg-neutral-900 transition flex items-center justify-center text-center"
            >
...
const sideInfo = [
  ...
  { label: 'Pengalaman Magang', value: 'Jitu Property sebagai Web Development, SEO Analyst, dan Content Writer' },
  { label: 'Pengalaman Kerja', value: 'Driver ShopeeFood, Surveyor Fotografi, Freelance' },
]
...
const tools = [
  { name: 'Microsoft Word', icon: 'https://img.icons8.com/color/96/microsoft-word-2019.png' },
  { name: 'Microsoft Excel', icon: 'https://img.icons8.com/color/96/microsoft-excel-2019.png' },
